    ...
    <section className="tf__about mt_250 xs_mt_195">
      <div className="container">
          ...
          <div className="row">
            ...
            <div className="col-xl-7 col-lg-7">
              <div className="tf__about_top_text">
                <div className="tf__about_top_text_center" style={{ width: '100%', paddingRight: '40px', textAlign: 'center' }}>
                  ...
                  <Link href="/contact" className="common_btn" style={{ display: 'inline-block', border: '2px solid white' }}>
                    Book Campus Visit
                  </Link>
                </div>
              </div>
        ...
        <div className="row">
          ...
          <div className="col-xl-6 col-sm-9 col-md-8 col-lg-6">
